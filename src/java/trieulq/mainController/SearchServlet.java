...
public class SearchServlet extends HttpServlet {
    private final String ERROR_PAGE = "admin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               String fullnameSearch= request.getParameter("txtsearch");
               MobileDAO dao = new MobileDAO();
               List<MobileDTO> result = dao.getAllMobileByName(fullnameSearch);
               ...
               if(result!= null){
                   ...
                   url =  SUCCESS_PAGE;
                   request.setAttribute("ERROR", "No record is matching with "+fullnameSearch );
               }
