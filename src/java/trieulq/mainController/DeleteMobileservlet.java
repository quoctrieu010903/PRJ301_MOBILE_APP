...
public class DeleteMobileservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = null;
        try {
            String mobile_name = request.getParameter("lastSearchValue");
            String searchValue = request.getParameter("pk");
            MobileDAO dao = new MobileDAO();
          boolean result = dao.deleteMobile(searchValue);
          if(result){
              url ="MainController?action=Search&txtsearch="+mobile_name;
